...
Original file is located at
    https://colab.research.google.com/drive/1gFskc_NiRdBBxGTuwqQHdCRNwMAqp1u9
"""
...
data_true = pd.read_csv('/content/True.csv', on_bad_lines='skip', engine='python')
